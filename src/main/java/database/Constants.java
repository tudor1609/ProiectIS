...
import static database.Constants.Roles.VANZATOR;  // Adăugarea rolului "Vanzator"
...
public class Constants {
    ...
    public static Map<String, List<String>> getRolesRights() {
        ...
        rolesRights.get(VANZATOR).add(SELL_BOOK);
    ...
    public static class Roles {
        ...
        public static final String VANZATOR = "vanzator";

        public static final String[] ROLES = new String[]{ADMINISTRATOR, EMPLOYEE, CUSTOMER, VANZATOR};  // Am adăugat "Vanzator"
    }
